        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/promotion"><i class="fa fa-bullhorn"></i><span>Promotion</span></a></li>
                    <li><a href="javascript:void(0)" aria-expanded="true"><i class="fa-solid fa-chair"></i><span>Booking
                            </span></a>
                        <ul class="collapse">

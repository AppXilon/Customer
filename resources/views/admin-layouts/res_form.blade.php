                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Choose the fields that should be available on the reservation form and Save</p>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6">
                                                <div class="form-row">
                                                    <label class="col-form-label">Card Bank</label>
                                                    <select class="form-control">
                                                        <option>No</option>
                                                        <option>Yes</option>
                                                        <option>Yes(required)</option>
